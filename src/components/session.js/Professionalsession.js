...
const Professionalsession = () => {
    ...
    const getsessions = async () => {
      const res = await axios.post(`${baseurl}/admin/professional/session_tokens_fetch/`, {
    ...
    const sendpageinquery=(val)=>{
      navigate({
        pathname:'/dashboard/professionalsession',
        search:`?page=${val}`
      })
    }
    ...
    const sessiondelete = async (id) => {
      ...
      const res = await axios.post(`${baseurl}/admin/delete_session_tokens_professional/`, {
    ...
    const searchfilter = async (query) => {
      const { data } = await axios.post(`${baseurl}/admin/professional/search_session_token/`, {
                        ...
                        <table id="result_list" className="table table-quadra">
                          ...
                          </tr>
                          {
                            sessions.map((curEle, i) => {
                              const { id, professional_name,created_at
                                ,token,professional_id,updated_at } = curEle
                              // console.log(rating);
