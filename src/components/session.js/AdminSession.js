...
const Session = () => {
  ...
  const getsessions = async () => {
    const res = await axios.post(`${baseurl}/admin/admin_session_list_fetch/`, {
                        ...
                        <table id="result_list" className="table table-quadra">
                          ...
                          </tr>
                          {
                            sessions.map((curEle, i) => {
                              const { id, admin_name,created_at
                              ...
                              return (
                                <tr id="tableRow" key={i}>
                                  ...
                                  {/* {admin_name.slice(0,1).toUpperCase() + admin_name.slice(1,25)} */}
                                  {
                                  admin_name.split(" ").map((word)=>{
                                      return (
                                      <>
