...
const Buysellpayment = () => {
    ...
    const getbuysellpayment = async () => {
      ...
      const res = await axios.post(`${baseurl}/admin/buy_sell_design_payment_client/`, {
    ...
    const handleClickOpen = (clientid,subcateid) => {
    setOpen(true);
  ...
  const handleClose = () => {
    ...
    const buyselldelete = async (id,cat_id,) => {
        console.log(cat_id);
      const res = await axios.post(`${baseurl}/admin/delete_buy_sell_payment_client/`, {
        ...localClients, client_id: id,sub_cat_id:cat_id
      });
      console.log(res);
      if (res.data.status === "Success") {
        settemp("temp")
    ...
    const sendpageinquery=(val)=>{
      navigate({
        pathname:'/dashboard/buysellpaymentClient',
        search:`?page=${val}`
      })
    }
              ...
              <div className="container-fluid">
                <div className="row">
                  <div id="testkar" className="col-12 heading-me-outer d-flex align-items-center">
                    ...
                    Clients BuySale Purchased Designs
                        ...
                        <table id="result_list" className="table table-quadra">
                          ...
                          </tr>
                          {
                            buysellpayment.map((curEle, i) => {
                              const { id, category_name, category_id, client_id, client_name, sub_category_id,project, professional_name, sub_category_name, professional_id, price, purchase_date, image, video, payment_status } = curEle
                              console.log(curEle);
                                    ...
                                    <td className="akign-center nowrap">
                                      <div style={{ display: "flex" }}>
                                        ...
                                        <button
                                          ...
                                          id={id}
                                          onClick={(e) => {
                                            handleClickOpen(client_id,sub_category_id)
                        ...
                        >
                          <DialogContent>
                            <DialogContentText id="alert-dialog-slide-description">
                              Are you sure you want to delete this Buysell ?
                            </DialogContentText>
                          </DialogContent>
                          <DialogActions>
                            <Button onClick={handleClose}>Cancel</Button>
                            <Button onClick={() => buyselldelete(id,sub_cat_id)}>Ok</Button>
                          </DialogActions>
                        </Dialog>
                        {counts > 1 && <Pagination
                          count={counts}
